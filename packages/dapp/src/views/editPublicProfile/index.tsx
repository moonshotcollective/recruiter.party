...
const EditPublicProfile = ({ nextStep, prevStep, activeStep }: EditPublicProfileProps) => {
  ...
  return (
      <Box as="main" w={'full'}>
        <Stack as="form" onSubmit={handleSubmit(onSubmit)}>
          <Button onClick={prevStep} w={24} pl={2} backgroundColor={"transparent"} color={accentColor}>
          ...
          <Flex>
            <Spacer />
            <Button onClick={prevStep} mr={2} backgroundColor={"transparent"} color={accentColor}>
              Back
            </Button>
            <Button
              _hover={{
